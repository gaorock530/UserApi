...
module.exports = (server, authentication) => {
  server.post('/todo/load', authentication({auth: 'SELF'}), (req, res) => {
    res.status(200).send({todos: req.user.todos});
  });
